    ...
    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700">
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
              ...
              <button
                ...
                className={`px-6 py-4 rounded-xl font-bold text-lg transition-all duration-300 ${
                  !isCustom && amount === presetAmount
                    ? "bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-lg shadow-primary-500/30 scale-105 dark:from-primary-600 dark:to-primary-700"
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 text-2xl font-bold text-neutral-900 bg-neutral-50 border-2 border-neutral-200 rounded-xl focus:border-primary-500 focus:ring-4 focus:ring-primary-500/20 transition-all outline-none dark:text-white dark:bg-neutral-700 dark:border-neutral-600 dark:focus:border-primary-500 dark:placeholder-neutral-500"
            />
          </div>
        </div>
        ...
        <Link href={ROUTES.DONATE}>
          <button className="w-full relative group px-8 py-5 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white font-bold text-lg rounded-xl transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-primary-500/40 overflow-hidden">
            {/* Shimmer effect */}
