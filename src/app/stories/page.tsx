      ...
      <section className="py-20 bg-white dark:bg-neutral-900">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            <div className="aspect-square lg:aspect-auto bg-gradient-to-br from-primary-200 to-secondary-200 rounded-2xl flex items-center justify-center shadow-lg overflow-hidden">
              <p className="text-neutral-400">{featuredStory.image}</p>
            </div>
            <div className="flex flex-col justify-center space-y-6">
              <div>
                <span className="inline-block px-4 py-1 bg-primary-100 text-primary-600 rounded-full text-sm font-semibold capitalize mb-4">
            ...
            {otherStories.map((story) => (
              <Link key={story.id} href={`${ROUTES.STORIES}/${story.id}`}>
                <Card hover className="h-full flex flex-col">
                  ...
                  <span className="inline-block px-3 py-1 bg-accent-100 text-accent-700 rounded-full text-xs font-semibold capitalize w-fit mb-2">
                    {story.category}
                  </span>
                  ...
                  <div className="mt-auto pt-4 border-t border-neutral-200 dark:border-neutral-700 flex items-center justify-between text-xs text-neutral-700 dark:text-neutral-400">
