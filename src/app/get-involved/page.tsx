      ...
      <section className="py-20 bg-neutral-900">
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            {/* Donate */}
            <Card hover className="flex flex-col bg-neutral-800 border-2 border-neutral-700 hover:border-orange-500 transition-all duration-300">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/20 rounded-full mb-4">
                <FaHeart className="w-8 h-8 text-orange-500" />
              </div>
              ...
              <Link href={ROUTES.DONATE}>
                <Button size="sm" className="w-full bg-orange-600 hover:bg-orange-700 text-white border-2 border-orange-600 hover:border-orange-700">
            ...
            <Card hover className="flex flex-col bg-neutral-800 border-2 border-neutral-700 hover:border-orange-500 transition-all duration-300">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/20 rounded-full mb-4">
                <FaHandHoldingHeart className="w-8 h-8 text-orange-500" />
              </div>
              <h3 className="text-2xl font-bold text-white mb-3">
                Volunteer
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx}>
                ...
                <p className="text-neutral-800 text-sm mt-3">{opp.description}</p>
              </Card>
            ))}
          </div>
        ...
        <div className="container-max">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <Card key={idx} className="border-l-4 border-l-primary-600 dark:bg-neutral-800">
                <p className="text-neutral-800 dark:text-neutral-200 italic mb-4">
                  &quot;{testimonial.quote}&quot;
                </p>
